          ...
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 my-4 w-full xl:w-1/5">
              ...
              <p className="text-justify">
                ...
                Reiciendis alias nostrum maiores quae magnam temporibus, veniam
                officia dicta corrupti cum impedit, accusamus voluptatum enim
                et.
              </p>
            </div>
            ...
            <div className="px-4 my-4 w-full sm:w-auto">
              ...
              <ul className="leading-8">
                ...
                <li>
                  <Link to={'/colleges'} className="hover:text-blue-400">
                    Colleges
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link to={'/my-college'} className="hover:text-blue-400">
                    My College
                  </Link>
                </li>
              </ul>
