...
import { login } from '../../assets/allImage';
import { useDispatch } from 'react-redux';
import { createUserWithEmailPass } from '../../redux/feature/users/userSlice';
...
const Register = () => {
  ...
  return (
    <div className="my-9 flex flex-col md:flex-row lg:flex-row max-w-7xl mx-auto  items-center ">
      <div className="w-1/2">
      ...
      <div className="w-1/2  grid place-items-center">
        <div className="bg-primary/5 w-full max-w-sm rounded-lg grid place-items-center p-10">
          <h1 className="mb-10 font-medium text-2xl">Register</h1>
